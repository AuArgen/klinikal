...
class Doctor(models.Model):
    ...
    last_name = models.CharField(max_length=255, verbose_name="Отечество", null=True, blank=True)
    slug = models.SlugField(unique=True, help_text='Поля автоматический заполняется!')
    ...
    phone = PhoneNumberField(verbose_name="Телефон номер", default="+996", null=True, blank=True)
    special = models.CharField(max_length=255, verbose_name='Специалист', default='Врач')
    kabinet = models.IntegerField(verbose_name='Кабинет', null=True, blank=True)
